...
{
    { -0.5f, -0.5f,  0.5f,  U0, V1,  1,1,1 },
    {  0.5f, -0.5f,  0.5f,  U1, V1,  1,1,1 },
    {  0.5f,  0.5f,  0.5f,  U1, V0,  1,1,1 },
    { -0.5f,  0.5f,  0.5f,  U0, V0,  1,1,1 },

    {  0.5f, -0.5f, -0.5f,  U0, V2,  1,1,1 },
    { -0.5f, -0.5f, -0.5f,  U1, V2,  1,1,1 },
    { -0.5f,  0.5f, -0.5f,  U1, V1,  1,1,1 },
    {  0.5f,  0.5f, -0.5f,  U0, V1,  1,1,1 },

    { -0.5f, -0.5f, -0.5f,  U1, V1,  1,1,1 },
    { -0.5f, -0.5f,  0.5f,  U2, V1,  1,1,1 },
    { -0.5f,  0.5f,  0.5f,  U2, V0,  1,1,1 },
    { -0.5f,  0.5f, -0.5f,  U1, V0,  1,1,1 },

    {  0.5f, -0.5f,  0.5f,  U1, V2,  1,1,1 },
    {  0.5f, -0.5f, -0.5f,  U2, V2,  1,1,1 },
    {  0.5f,  0.5f, -0.5f,  U2, V1,  1,1,1 },
    {  0.5f,  0.5f,  0.5f,  U1, V1,  1,1,1 },

    { -0.5f,  0.5f,  0.5f,  U2, V0,  1,1,1 },
    {  0.5f,  0.5f,  0.5f,  U3, V0,  1,1,1 },
    {  0.5f,  0.5f, -0.5f,  U3, V1,  1,1,1 },
    { -0.5f,  0.5f, -0.5f,  U2, V1,  1,1,1 },

    {  0.5f, -0.5f,  0.5f,  U2, V1,  1,1,1 },
    { -0.5f, -0.5f,  0.5f,  U3, V1,  1,1,1 },
    { -0.5f, -0.5f, -0.5f,  U3, V2,  1,1,1 },
    {  0.5f, -0.5f, -0.5f,  U2, V2,  1,1,1 },
};
...
{  
    ...
    for (int asset_index = 0; asset_index < 1024; asset_index++)
    {
        ...
        if (path == 0) break;
        if (assets_to_load[asset_index].type != CUBE_3D) continue;
...
void rendererDraw(void)
{
    ...
    for (uint32 cube_instance_index = 0; cube_instance_index < cube_instance_count; cube_instance_index++)
    {
        ...
        if ((int32)cube_instance->asset_index != last_asset)
        {
            ...
            last_asset = (int32)cube_instance->asset_index;
        }
